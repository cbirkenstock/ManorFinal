...
export declare class Chat {
  ...
  readonly chatImage?: string | null;
  ...
  readonly isForEveryone?: boolean | null;
...
export declare class ChatUser {
  ...
  static copyOf(source: ChatUser, mutator: (draft: MutableModel<ChatUser, ChatUserMetaData>) => MutableModel<ChatUser, ChatUserMetaData> | void): ChatUser;
}
...
export declare class ChatUserMessage {
  ...
  static copyOf(source: ChatUserMessage, mutator: (draft: MutableModel<ChatUserMessage, ChatUserMessageMetaData>) => MutableModel<ChatUserMessage, ChatUserMessageMetaData> | void): ChatUserMessage;
}